...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = TX_SIM7680_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(TX_SIM7680_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = RX_SIM7680_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(RX_SIM7680_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    */
    ...
    /* USART6_RX: PiLink RX-to-IDLE over a circular DMA buffer. */
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX_SIM7680_Pin|RX_SIM7680_Pin);
